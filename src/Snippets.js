...
const Snippets = {
  tags: function ({ id, events, dataLayer, dataLayerName, preview, auth }) {
    ...
    const iframe = `
      <iframe src="https://tracking.myka.com/ns.html?id=${id}${gtm_auth}${gtm_preview}&gtm_cookies_win=x"
    ...
    const script = `
      (function(w,d,s,l,i){w[l]=w[l]||[];
        ...
        j.async=true;j.src='https://tracking.myka.com/gtm.js?id='+i+dl+'${gtm_auth}${gtm_preview}&gtm_cookies_win=x';
